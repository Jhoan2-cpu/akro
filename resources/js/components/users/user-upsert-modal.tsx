...
import { ChevronDown, Circle, CloudUpload, X } from 'lucide-react';
...
export default function UserUpsertModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-3 backdrop-blur-sm sm:p-6">
            <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl border border-white/10 bg-white text-neutral-800 shadow-[0_30px_80px_rgba(15,23,42,0.35)]">
                <div className="absolute top-5 right-5">
                    <Button
                        asChild
                        variant="ghost"
                        size="icon"
                        className="rounded-full text-neutral-500 hover:bg-neutral-100 hover:text-neutral-800"
                    >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <select
                                            ...
                                            className="h-12 w-full appearance-none rounded-2xl border border-neutral-200 bg-neutral-50 px-4 pr-10 text-sm outline-none transition focus:border-emerald-500"
                                        >
                                        ...
                                        <ChevronDown className="pointer-events-none absolute top-1/2 right-4 size-4 -translate-y-1/2 text-neutral-400" />
                                    </div>
